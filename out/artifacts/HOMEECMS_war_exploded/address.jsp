...
<div class="readd">
    <form action="#" method="get"><input type="text" class="on" value="六六六"/><input type="text" value="157****0022"/>
        <div class="city"><select name="">
            <option value="省份/自治区">福建省</option>
        </select><select>
            <option value="城市/地区">厦门市</option>
        </select><select>
            <option value="区/县">集美区</option>
        </select><select>
            <option value="配送区域">孙坂南路</option>
        </select></div>
        <textarea name="" rows="" cols="" placeholder="详细地址">厦门工学院</textarea><input type="text" placeholder="邮政编码"
                                                                                    value="063000"/>
...
<div class="footer">
    <div class="top">
        <div class="wrapper">
            ...
            <div class="clearfix"><a href="#2" class="fl"><img src="img/foot3.png"/></a><span class="fl">满200包邮</span>
            </div>
